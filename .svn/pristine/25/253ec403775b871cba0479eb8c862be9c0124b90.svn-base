                    ...
                    <div class="col-lg-12 data-total clear-padding">
                        ...
                        <div class="data-tab border-bot" style="height:auto;overflow:hidden;">
                            <ul class="data-tab-btn">
                                <li><button class="blue-bag" onclick="chart('register','人')">注册用户数</button></li>
                                <li><button onclick="chart('view','次')">微信访问数</button></li>
                                <li><button onclick="chart('guarantee','辆')">保障中车辆</button></li>
                                <li><button onclick="chart('shop','家')">商家数</button></li>
                                <li><button onclick="chart('channel','家')">其他渠道数</button></li>
                                <li><button onclick="chart('event','单')">申请理赔</button></li>
                                <li><button onclick="chart('foundation','元')">互助金</button></li>
                                <li><button onclick="chart('initNum','辆')">待支付</button></li>
                                <li><button onclick="chart('observationNum','辆')">观察期</button></li>
                                <li><button onclick="chart('guaranteeNum','辆')">保障中</button></li>
                                <li><button onclick="chart('outNum','辆')">退出</button></li>
                                <li><button onclick="chart('twiceRecharge','次')">二次充值</button></li>
                            </ul>
