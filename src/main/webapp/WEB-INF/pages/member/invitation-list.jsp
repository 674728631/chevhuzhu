        ...
        <div class="row margin-row-max">
            <div class="col-sm-12 new-search-btn">
                ...
                <div class="" style="position:relative;float:left;display: inline-block;margin-left:30px;">
                 ...
                 <div class="" style="position:relative;float:left;display: inline-block;margin-left:250px;margin-top: 8px">
                    <span id="inviationInfo"></span>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function loadListDate(){
    	...
    	var strJson = {"customerPN":searchInfo,"beginTime":beginTimeCondition,"endTime":endTimeCondition};
    	$.ajax({
    		 type : "post",
             dataType : "json",
             ...
             url: "${ctx}/invitation/getListDate",
             success:function(datas){
            	 if(datas.code == "0"){
            		 var repData = datas.data;
            		 $("#businessNum").html("商家("+ex.judgeEmptyOr0(repData.businessCount)+")");
            		 $("#channelNum").html("其他渠道("+ex.judgeEmptyOr0(repData.channelCount)+")");
            		 $("#inviationInfo").html(repData.inviationInfo); 
            	 }
             }
    	});
    }
